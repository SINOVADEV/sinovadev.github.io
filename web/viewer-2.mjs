...
class XfaLayerBuilder {
  constructor({
    ...
    G_annotationStorage = this.annotationStorage;
    this.linkService = linkService;
...
class PDFViewer {
  ...
  */
  ...
  set annotationEditorParams({
    ...
    if(this.pdfDocument && this.pdfDocument.annotationStorage && this.pdfDocument.annotationStorage.size > 0){
      var count = 0;
      ...
      if(!this.validateOption(this.pdfDocument.annotationStorage.getAll())){
        this.showAlert("¡Advertencia!", "Solo puede agregar una firma o imagen.", "error");
        // Se deja deshabilitado
        return false
      }
      
      /*if(elements && elements.stamp && (elements.stamp.hasAltText || elements.stamp.hasNoAltText)){
        var hasAltText= Number(elements.stamp.hasAltText); 
        var hasNoAltText = Number(elements.stamp.hasNoAltText);

        var totalElements = hasAltText + hasNoAltText;
        if(totalElements > 0){
           this.showAlert("¡Advertencia!", "Solo puede agregar una imagen.", "error");
           return false;
        }
      ...
      eventDetails: {
        get mode() {
          ...
          if(_this.#validateOption_()){
            ...
            _this.#showAlert("¡Advertencia!", "Solo puede agregar una firma o imagen.", "error");
            //alert("NO PUEDE MAS")
            // Se deja deshabilitado
...
const PDFViewerApplication = {
  ...
  /**
   * JHON - permite obter la cantidad de registros
  */
  get allStorage(){
